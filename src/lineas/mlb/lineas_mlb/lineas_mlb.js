...
export const Lineas_MLB = props => {
    ...
    return (
        <div className={color_of_text}>
            <div className="row g-0 bg_lines text-center odds-list">
                ...
                <div className="odds-span text_dest"></div>
                <div className="odds-span text_dest">RL</div>
